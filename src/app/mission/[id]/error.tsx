    ...
    <main className="min-h-screen bg-[var(--color-surface)] flex items-center justify-center p-6">
      <div className="max-w-md text-center space-y-6">
        ...
        <p className="text-slate-500 font-medium text-sm leading-relaxed">
          Could not load this mission. It may have been completed or moved.
        </p>
        <div className="flex items-center justify-center gap-4">
          <button
            type="button"
            onClick={reset}
            className="bg-indigo-600 text-white font-black px-8 py-4 rounded-2xl hover:bg-indigo-700 transition-colors duration-200 text-sm uppercase tracking-widest cursor-pointer"
          >
            Retry
          </button>
          <Link
